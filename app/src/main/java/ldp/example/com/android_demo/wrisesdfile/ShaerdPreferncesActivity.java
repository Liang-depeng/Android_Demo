package ldp.example.com.android_demo.wrisesdfile;
...
import ldp.example.com.android_demo.R;
         ...
         */
public class ShaerdPreferncesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBt_s.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                edit.clear();
                edit.commit();
                Toast.makeText(ShaerdPreferncesActivity.this, "清理完毕", Toast.LENGTH_SHORT).show();
    ...
    private void setting() {
        ...
        mCk_1.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                Toast.makeText(ShaerdPreferncesActivity.this, "checkbox_1状态已更新", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        mCk_2.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                Toast.makeText(ShaerdPreferncesActivity.this, "checkbox_2状态已更新", Toast.LENGTH_SHORT).show();
            }
        });
...
//            @Override
//            public void onClick(View v) {
//                Toast.makeText(ShaerdPreferncesActivity.this, "点击", Toast.LENGTH_SHORT).show();
//            }
//        });
    }
}
